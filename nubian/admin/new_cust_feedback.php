    ...
    <section class="container">
        <div class="row main-container">
            ...
            <div class="col-md-6 col-md-offset-4">
                <a href="cust_feedback.php" class="btn btn-sm btn-success">Feedback history</a>
                <a href="new_cust_feedback.php" class="btn btn-sm btn-info">New feedback</a>
            </div>
            ...
            <div id="iframe" class="">
                ...
                <h2 class="legend">New Customer Feedback</h2>
                        <fieldset class="">
                                ...
                                <table id="dataTables-example"class="table table-striped table-responsive tableData">
                                   ...
                                   <?php
                                   $select="SELECT * FROM customer c INNER JOIN feedback f ON c.cust_id = f.cust_id WHERE reply='Pending' ";
                                   ...
                                   while ($row=mysqli_fetch_array($query)) {
                                       ...
                                       <tr class="header">
                                           <td>
                                             <a href="reply_cust_feedback.php?get=<?php echo $row['fb_id'] ?>" class="text-info">Manage</a>
