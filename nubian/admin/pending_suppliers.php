...
<div id="main_content" class="none" style="display: block;">
    ...
    if($_SESSION['user']=='Admin'){
        ...
        include '../php_files/user_left_bar.php';
    ...
    <section class="container">
        <div class="row main-container">
            ...
            <div class="col-md-6 col-md-offset-4">
                <a href="approved_suppliers.php" class="btn btn-sm btn-success">Approved Suppliers</a>
                <a href="pending_suppliers.php" class="btn btn-sm btn-info">Pending Suppliers</a>
                <a href="rejected_suppliers.php" class="btn btn-sm btn-danger">Rejected Suppliers</a>
            </div>
            ...
            <div id="iframe" class="">
                ...
                <h2 class="legend">Pending suppliers accounts</h2>
                        <fieldset class="">
                                ...
                                <table id="dataTables-example"class="table table-striped table-responsive tableData">
                                   ...
                                   <?php
                                   $select="SELECT * FROM suppliers WHERE status='Pending' ";
                                   ...
                                   while ($row=mysqli_fetch_array($query)) {
                                       ...
                                       <tr class="header">
                                           <td>
                                             <a href="manage_suppliers.php?get=<?php echo $row['supplier_id'] ?>" class="text-info">Manage</a>
