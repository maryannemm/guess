    ...
    <section class="container">
        <div class="row main-container">
            ...
            <div class="col-md-6 col-md-offset-4">
                <a href="sup_feedback.php" class="btn btn-sm btn-success">Supplier feedback</a>
                <a href="new_sup_feedback.php" class="btn btn-sm btn-info">New supplier feedback</a>
            </div>
            ...
            <div id="iframe" class="">
                ...
                <h2 class="legend">New Suppliers Feedback</h2>
                        <fieldset class="">
                                ...
                                <table id="dataTables-example"class="table table-striped table-responsive tableData">
                                   ...
                                   <?php
                                   $select="SELECT * FROM suppliers s INNER JOIN feedback_supplier f ON s.supplier_id = f.supplier_id WHERE reply='Pending' ";
                                   ...
                                   while ($row=mysqli_fetch_array($query)) {
                                       ...
                                       <tr class="header">
                                           <td>
                                             <a href="reply_sup_feedback.php?get=<?php echo $row['fd_id'] ?>" class="text-info">Manage</a>
