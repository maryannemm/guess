...
if(isset($_POST['approveBtn'])) {
    ...
    if (empty($status)) {
        ...
        $update = "UPDATE suppliers SET status='Approved' WHERE supplier_id='" . $_GET['get'] . "'";
...
if(isset($_POST['rejectBtn'])) {
    ...
    if (empty($remark)) {
        ...
        $update = "UPDATE suppliers SET status='Rejected',remarks='$remark' WHERE supplier_id='" . $_GET['get'] . "'";
        if ($query = mysqli_query($con, $update)) {
            $swal = "success";
    ...
    <section class="container">
        <div class="row main-container">
            ...
            <article class="col-sm-9 col-lg-10 main-content" id="main-content" style="min-height: auto; height: auto;">
                ...
                <div class="col-md-1"><a href="pending_suppliers.php.php"class="btn btn-danger btn-sm">Go back</a> </div>
                <div class="col-md-3">
            ...
            <div id="iframe" class="">
                ...
                <h2 class="legend">Manage supplier account</h2>
                        <fieldset class="">
                                ...
                                <table id="dataTables-example"class="table table-striped table-responsive tableData">
                                   ...
                                   <?php
                                   $select="SELECT * FROM suppliers WHERE supplier_id='".$_GET['get']."' ";
