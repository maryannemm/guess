    ...
    <section class="container">
        <div class="row main-container">
            ...
            <div id="iframe" class="">
                ...
                <h2 class="legend">Suppliers Feedback</h2>
                        <fieldset class="">
                                ...
                                <table id="dataTables-example"class="table table-striped table-responsive tableData">
                                   ...
                                   <?php
                                   $select="SELECT * FROM suppliers s INNER JOIN feedback_supplier f ON s.supplier_id = f.supplier_id WHERE NOT reply='Pending' ";
