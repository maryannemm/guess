...
if(isset($_POST['updateBtn'])){
    ...
    if(empty($name)|| empty($username)|| empty($phoneno)|| empty($email)){
        $swal="error";
        ...
        $select="SELECT * FROM suppliers WHERE username='$username' AND NOT supplier_id='".$_SESSION['sID']."'";
        ...
        if($check=mysqli_num_rows($query)>0){
            ...
            $select="SELECT * FROM suppliers WHERE phone_no='$phoneno'AND NOT supplier_id='".$_SESSION['sID']."'";
            $query=mysqli_query($con,$select);
            if($check=mysqli_num_rows($query)>0){
                $swal="error";
                ...
                $select="SELECT * FROM suppliers WHERE email='$email' AND NOT AND NOT supplier_id='".$_SESSION['sID']."'";
                $query=mysqli_query($con,$select);
                if($check=mysqli_num_rows($query)>0){
                    $swal="error";
                    ...
                    $update="UPDATE  suppliers SET supplier_name='$name',
...
swal("SUCCESS","'.$fb.'","success")
            ...
            <div class="span9">
                ...
                <div class="span4 offset1 well">
                    ...
                    <?php
                    $select="SELECT * FROM suppliers WHERE supplier_id='".$_SESSION['sID']."' ";
                    $query=mysqli_query($con,$select);
                    ...
                    ?>
                        ...
                        <form method="post"autocomplete="off">
                            ...
                            <input class="span3 " name="name"value="<?php echo $row['supplier_name']?>"  type="text" id="inputEmail1" placeholder="First name">
