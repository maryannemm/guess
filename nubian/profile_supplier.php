...
swal("","'.$_SESSION['success'].'","success")
            ...
            <div class="span9">
                ...
                <div class="span4 offset1 well">
                    ...
                    <tr class="header">
                    <tr><td><b>Name </b></td><td><?php echo $row['supplier_name'] ?></td></tr>
                    ...
                    <tr><td><b>Date created </b>   <td><?php echo $row['date_added'] ?></td></tr>
                    <tr><td colspan="2">
                            <a href="update_supplier.php"class="btn  btn-primary">Update profile</a>
                        </td></tr>
